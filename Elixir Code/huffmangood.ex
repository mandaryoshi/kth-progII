defmodule Huffman do
  ...
  #  seq = Map.get(table, char)
  #  seq ++ encode(rest, table)
  #end

  #def lookup(char, [{char, seq} | _]) do seq end
  #def lookup(char, [_|rest]) do lookup(char, rest) end

  #time complexity of encode = O(n * c * log(c))
  #n is the length of the text, c is the length of the alphabet (how many chars we're using), and log(c) is the append, where you find the length of the seq
  #make it better by having a tuple of characters, makes the c constant time
